        ...
        init: function( editor ) {
            ...
            for ( i = 0; i < languagesConfigStrings.length; i++ ) {
                ...
                items[ languageButtonId ] = {
                    ...
                    className: 'cke_menubutton__'+( '' + parts[ 2 ] ).toLowerCase(),
                    onClick: function() {
            ...
            items.language_remove = {
                ...
                order: items.length,
                className: 'cke_menubutton__language_remove',
                onClick: function() {
            ...
            editor.addMenuGroup( 'language_remove', 1 );
            editor.addMenuGroup( 'language' ); // Group order is skipped intentionally, it will be placed at the end.
            ...
            editor.ui.add( 'Language', CKEDITOR.UI_MENUBUTTON, {
                ...
                toolbar: 'bidi,30',
                command: 'language',
                className: 'cke_button__taolanguage',
                onMenu: function() {
                    // workaround against forcing .cke_menu_panel{ visibility: hidden }
                    document.body.classList.add( ENABLE_PANEL_CLASS );
